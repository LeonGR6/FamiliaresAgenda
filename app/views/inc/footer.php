  ...
  <div class="row justify-content-center"> <!-- Centramos toda la fila -->
    ...
    <div class="col-12 col-lg-10 d-flex flex-column flex-md-row align-items-center justify-content-center">
      ...
      <div class="d-none d-lg-flex mx-lg-4 mx-xl-5">
        <img src="/mvc-php/public/images/logoblanco.png" class="img-fluid" alt="Logo" style="max-height: 120px;">
      </div>

      <!-- Contenido central -->
      <div class="text-center text-md-left mx-3 mx-md-4 mx-lg-4">
        <ul class="list-unstyled m-0">
          <li class="mb-2">
            <a href="https://goo.gl/maps/L27vDRLym1cNcNVm6" target="_blank" class="text-light text-decoration-none">
